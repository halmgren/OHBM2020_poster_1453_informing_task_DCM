...
for isub=14:Nsub
    ...
    DCM_csd=load_prior_DCM(['/media/hannes/Almgren_Disk4/Project_OHBM_2020/Specific Data/Rest/drive-download-20191219T153119Z-001/' subfold{isub} '/DCM_estimated_csd.mat']);
    DCM.M.pE.A = DCM_csd{1}.Ep.A;
    
    %pC=DCM_csd{1}.Cp; %posterior becomes prior
